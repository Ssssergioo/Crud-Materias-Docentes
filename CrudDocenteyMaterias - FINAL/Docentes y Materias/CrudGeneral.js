...
function dibujarTablaMateria() {
    ...
    materias.obtenerTodos().forEach((materia, index) => {
        let docenteIndex = index % docentes.obtenerTodos().length; // Índice del docente según la iteración actual
        console.log(docenteIndex);
    
        let docente = docentes.obtenerTodos()[docenteIndex];
